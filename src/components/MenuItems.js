    ...
    return(
        ...
        <li className="nav-item mt-3">
            ...
            {showItem?menu.children.map((submenu,i)=>(
                checkAllow(submenu)&&
                <a className={url===submenu.url?"nav-link text-white active bg-gradient-secondary"
                :"nav-link text-dark"} href={submenu.href} key={i}
        ...
        <li className="nav-item">
            <a className={props.active?"nav-link text-white active bg-gradient-secondary"
            :"nav-link text-dark"} href={menu.href}>
                <div className="text-dark text-center me-2 d-flex align-items-center justify-content-center">
